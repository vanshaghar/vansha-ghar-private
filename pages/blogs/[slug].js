...
const BlogDetails = ({
    ...
    return (
        <Layout>
            <PageBanner pageName={
                "Article"
            } title={postData.blogcategory.name} />
                                        ...
                                        <div className="content">
                                            <span className="post-date">
                                                <a href="#">
                                                    ...
                                                    {new Date(navigationPosts.prev?.createdAt).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' })}
                                                </a>
                                            </span>
                                            <h6>
                                    ...
                                    <div className="next-post post-nav-item d-flex mb-30">
                                        ...
                                        <div className="content">
                                            <span className="post-date">
                                                <a href="#">
                                                    <i className="far fa-calendar-alt" />
                                                    {new Date(navigationPosts.next?.createdAt).toLocaleDateString('en-US', { year: 'numeric', month: 'short', day: 'numeric' })}
                                                </a>
                                            </span>
                                            <h6>
                            ...
                            <div className="sidebar-widget-area">
                                ...
                                <div className="sidebar-widget recent-post-widget mb-10 wow fadeInUp">
                                    ...
                                    <ul className="recent-post-list">
                                        {
                                            blogslist.filter(item => item.featuredPost).map((post, index) => (
